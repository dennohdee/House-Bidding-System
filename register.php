...
include "conn.php";
 ...
 $othernames = stripslashes($_REQUEST['othernames']); 
 ...
 $password = stripslashes($_REQUEST['password']);
     ...
     $query = "INSERT INTO userdetails (surname,othernames,phone,email,idno,password,type)
       VALUES('$surname','$othernames','$phone','$email','$idno','$password','$type') ";
